...
static const struct reg_sequence imx708_common_regs[] = {
	...
	{0x350d, 0x00},
	{0x0224, 0x01},
	{0x0225, 0xf4}, /* SHT_EXPOSURE = 500 */
	{0x3116, 0x01},
	{0x3117, 0xf4}, /* MID_EXPOSURE = 500 */
	{0x0216, 0x00},
	{0x0217, 0x00}, /* SHT_ANALOG_GAIN = 0 */
	{0x0218, 0x01},
	{0x0219, 0x00}, /* SHT_DIGITAL_GAIN = 0x100 */
	{0x3118, 0x00},
	{0x3119, 0x00}, /* MID_ANALOG_GAIN = 0 */
	{0x311a, 0x01},
	{0x311b, 0x00}, /* MID_DIGITAL_GAIN = 0x100 */
	{0x3366, 0x00},
	{0x3367, 0x00}, /* AEHIST1_AREA_WIDTH = 0 */
	{0x3368, 0x00},
	{0x3369, 0x00}, /* AEHIST1_AREA_HEIGHT = 0 */
...
static const struct reg_sequence imx708_mode_4608x2592_regs[] = {
	{0x0342, 0x3d},
	{0x0343, 0x20}, /* LINE_LENGTH = 15648 */
	{0x0340, 0x0a},
	{0x0341, 0x59}, /* FRAME_LENGTH = 2649 */
	{0x0344, 0x00},
	{0x0345, 0x00}, /* X_ADD_STA = 0 */
	{0x0346, 0x00},
	{0x0347, 0x00}, /* Y_ADD_STA = 0 */
	{0x0348, 0x11},
	{0x0349, 0xff}, /* X_ADD_END = 4607 */
	{0x034a, 0x0a},
	{0x034b, 0x1f}, /* Y_ADD_END = 2591 */
	{0x0220, 0x62},
	{0x0222, 0x01}, /* HDR off */
	{0x0900, 0x00},
	...
	{0x0902, 0x0a},
	{0x3200, 0x01},
	{0x3201, 0x01}, /* Binning priority */
	{0x32d5, 0x01},
	{0x32d6, 0x00}, /* QBC remosaic on */
	{0x32db, 0x01},
	{0x32df, 0x00},
	{0x350c, 0x00},
	{0x350d, 0x00},
	{0x0408, 0x00},
	{0x0409, 0x00}, /* Digital crop off */
	{0x040a, 0x00},
	{0x040b, 0x00},
	{0x040c, 0x12},
	{0x040d, 0x00}, /* DIG_CROP_W = 4608 */
	{0x040e, 0x0a},
	{0x040f, 0x20}, /* DIG_CROP_H = 2592 */
	{0x034c, 0x12},
	{0x034d, 0x00}, /* X_OUTPUT = 4608 */
	{0x034e, 0x0a},
	{0x034f, 0x20}, /* Y_OUTPUT = 2592 */
	{0x0301, 0x05},
	{0x0303, 0x02}, /* PLL */
	{0x0305, 0x02},
	{0x0306, 0x00},
	...
	{0x3cbf, 0x00},
	{0x0202, 0x0a},
	{0x0203, 0x29}, /* Exposure = 0xa29 */
	{0x0224, 0x01},
	{0x0225, 0xf4}, /* Short exposure */
	{0x3116, 0x01},
	{0x3117, 0xf4}, /* Mid exposure */
	{0x0204, 0x00},
	{0x0205, 0x00}, /* Analog gain = 0 */
	{0x0216, 0x00},
	{0x0217, 0x00},
	{0x0218, 0x01},
	{0x0219, 0x00},
	{0x020e, 0x01},
	{0x020f, 0x00}, /* Digital gain = 0x100 */
	{0x3118, 0x00},
	{0x3119, 0x00},
	{0x311a, 0x01},
	{0x311b, 0x00},
...
static const struct reg_sequence imx708_mode_2x2binned_regs[] = {
	{0x0342, 0x1e},
	{0x0343, 0x90}, /* LINE_LENGTH = 7824 */
	{0x0340, 0x05},
	{0x0341, 0x38}, /* FRAME_LENGTH = 1336 */
	{0x0344, 0x00},
	{0x0345, 0x00},
	{0x0346, 0x00},
	{0x0347, 0x00},
	...
	{0x040b, 0x00},
	{0x040c, 0x09},
	{0x040d, 0x00}, /* DIG_CROP_W = 2304 */
	{0x040e, 0x05},
	{0x040f, 0x10}, /* DIG_CROP_H = 1296 */
	{0x034c, 0x09},
	{0x034d, 0x00}, /* X_OUTPUT = 2304 */
	{0x034e, 0x05},
	{0x034f, 0x10}, /* Y_OUTPUT = 1296 */
	{0x0301, 0x05},
	{0x0303, 0x02},
	{0x0305, 0x02},
	{0x0306, 0x00},
...
static const struct reg_sequence imx708_mode_2x2binned_720p_regs[] = {
	{0x0342, 0x14},
	{0x0343, 0x60}, /* LINE_LENGTH = 5216 */
	{0x0340, 0x04},
	{0x0341, 0xb6}, /* FRAME_LENGTH = 1206 */
	{0x0344, 0x03},
	{0x0345, 0x00}, /* X_ADD_STA = 768 */
	{0x0346, 0x01},
	{0x0347, 0xb0}, /* Y_ADD_STA = 432 */
	{0x0348, 0x0e},
	{0x0349, 0xff}, /* X_ADD_END = 3839 */
	{0x034a, 0x08},
	{0x034b, 0x6f}, /* Y_ADD_END = 2159 */
	{0x0220, 0x62},
	{0x0222, 0x01},
	{0x0900, 0x01},
	{0x0901, 0x22},
	...
	{0x040b, 0x00},
	{0x040c, 0x06},
	{0x040d, 0x00}, /* DIG_CROP_W = 1536 */
	{0x040e, 0x03},
	{0x040f, 0x60}, /* DIG_CROP_H = 864 */
	{0x034c, 0x06},
	{0x034d, 0x00}, /* X_OUTPUT = 1536 */
	{0x034e, 0x03},
	{0x034f, 0x60}, /* Y_OUTPUT = 864 */
	{0x0301, 0x05},
	{0x0303, 0x02},
	{0x0305, 0x02},
	{0x0306, 0x00},
